...
module.exports = {
  "content": [
    ...
    [
      ...
      [
        ...
        " parameter automatically adds dependencies to package.json."
      ]
    ],
    [
      "h2",
  ...
  "meta": {
    ...
    "title": "Import Module",
    "type": "Introduction",
    "filename": "docs/import.en-US.md"
  },
  "description": [
    "section",
    [
      "p",
      "In addition to the antd components and the built-in business components of the scaffold, sometimes we need to introduce other external modules. Here we introduce the rich text component ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        "a",
        {
          ...
          "href": "#Introduce-Dependencies",
          "title": "Introduce Dependencies"
        },
        "Introduce Dependencies"
      ]
    ],
