...
module.exports = {
  "content": [
    ...
    [
      ...
      {
        "lang": "bash",
        "highlighted": "$ <span class=\"token function\">npm</span> run test:all  <span class=\"token comment\" spellcheck=\"true\"># Execute all the tests</span>"
      },
      [
        "code",
    ...
    [
      "p",
      "Unit tests are used to test the appearance of React UI components. By referencing ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "For example, we could create a file ",
      [
        "code",
        "src/routes/Result/Success.test.js"
      ],
      " to test the UI appearance of ",
      [
        "code",
        "Result/Success.js"
      ],
    ...
    [
      ...
      " is used as a test library, which provides a number of useful APIs to help us test React components. As for the assertion library, we choose ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      {
        "lang": "bash",
        "highlighted": "$ <span class=\"token function\">npm</span> <span class=\"token function\">test</span> src/routes/Result/Success.test.js  <span class=\"token comment\" spellcheck=\"true\"># test Success.test.js</span>\n$ <span class=\"token function\">npm</span> <span class=\"token function\">test</span> src/routes                         <span class=\"token comment\" spellcheck=\"true\"># test all test case file in routes</span>"
      },
      [
        "code",
    ...
    [
      "p",
      "We can use the following way to test the components wrapped by dva ",
      [
        "code",
        "connect"
      ],
    ...
    [
      ...
      " as the tool of e2e testing, puppeteer is a headless Chrome tool which created by Google, it uses chrome/chromium as the browser environment by default to run your application, and provides a very semantic API for describing business logic."
    ],
    [
      "h3",
    ...
    [
      "p",
      "We write a test case to ensure this process. Create a ",
      [
        "code",
        "Login.e2e.js"
      ],
      ...
      "directory and describe the test cases as described above for your business needs."
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "Run the following command to execute all ",
      [
        "code",
        "*.e2e.js"
      ],
      " test cases under src."
    ],
    [
      "pre",
      {
    ...
    [
      ...
      [
        ...
        " before testing e2e cases locally, or it will throw ",
        [
          "code",
    ...
    [
      ...
      " configuration you can enter the watch mode, ",
      [
        "code",
        "in which"
      ],
      " when you modify and save the file, jest will automatically execute the corresponding test cases. Jest's command line tools also provide a variety of convenient shortcuts to execute the use cases you need."
    ],
    [
      "p",
      [
    ...
    [
      ...
      " configuration to display the project's test coverage."
    ],
    [
      "p",
      [
    ...
    [
      ...
      " to temporarily ignore the test case, ",
      [
        "code",
        "fit()"
      ],
      " to focus on the current test case and ignore all other test cases. These two methods can help you to focus on the current need of test cases in the development process."
    ],
    [
      "h2",
    ...
    [
      "p",
      "If you need access to integration testing environment such as travis, CircleCI, Gitlab CI, you can refer to ",
      [
        "a",
        {
          "title": null,
          "href": "https://github.com/ant-design/ant-design-pro/blob/master/.travis.yml"
        },
        ".travis.yml"
      ],
    ...
    [
      "p",
      "Note that the e2e test requires integrated environment support ",
      [
        "a",
        {
          "title": null,
      ...
      ", and if not, you can run unit tests separately using ",
      [
        "code",
        "npm test .test.js"
      ],
  ...
  "meta": {
    ...
    "title": "UI Test",
    "type": "Advanced",
    "filename": "docs/ui-test.en-US.md"
  },
  "toc": [
    "ul",
    [
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Focus-or-ignore-test-cases",
          "title": "Focus or ignore test cases"
        },
        "Focus or ignore test cases"
      ]
    ],
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Access-integration-testing-services",
          "title": "Access integration testing services"
        },
        "Access integration testing services"
      ]
    ],
