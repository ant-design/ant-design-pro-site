...
我们基于上述目标和模板内容构建了一套基于 React 的中后台管理控制台的脚手架，它可以帮助你快速搭建企业级中后台产品原型。
...
如果你是产品或设计师，你可以找到和 Pro 一一配套的 [Axure/Sketch 设计资源](http://pro.ant.design/docs/resource)，大幅度提升设计效率和沟通效率。
