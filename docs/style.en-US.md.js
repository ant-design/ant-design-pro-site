...
module.exports = {
  "content": [
    ...
    [
      "p",
      "Ant Design Pro defaults to using less as the style language, we recommend that you learn about the features of ",
      [
        "a",
        {
          "title": null,
      ...
      " before using it or sometimes when you have some questions."
    ],
    [
      "h2",
      "CSS Modules"
    ...
    [
      "p",
      "In the above style file, ",
      [
        "code",
        ".title"
      ],
      " will only work in this file, you can use the same selector name in any other file, it will not affect here. But sometimes, we just want a global style which can take effect everywhere? You can use ",
      [
        "code",
        ":global"
      ],
    ...
    [
      "p",
      "The basic principle of CSS Modules is very simple. that is: for each class name (without ",
      [
        "code",
        ":global"
      ],
      ") in accordance with some rules for conversion, to ensure its uniqueness. If you look at the dom structure of this example in your browser, you will find that the actual rendering like this:"
    ],
    [
      "pre",
      {
    ...
    [
      ...
      [
        ...
        [
          ...
          ". Others such as property selectors and tag selectors are not processed. It is recommended to take className as the first choice."
        ]
      ],
      [
        "li",
      ...
      [
        ...
        [
          ...
          [
            ...
            "CSS Modules Detailed and Practice in React"
          ]
        ]
      ]
    ],
    ...
    [
      "p",
      "Here you can place some tool functions, such as clearing the floating ",
      [
        "code",
        ".clearfix"
      ],
    ...
    [
      ...
      ", which contains some basic layout styles, is referenced by ",
      [
        "code",
        "src/layouts/BasicLayout.js"
      ],
      ", and the pages that use this layout do not need to care about the overall layout settings anymore. If you need to use other layouts in your project, it is also recommended to put layout-related js and less in ",
      [
        "code",
        "src/layouts"
      ],
    ...
    [
      "p",
      "Specific page-related style, such as ",
      [
        "code",
        "src/routes/Dashborad/Monitor.less"
      ],
      ", the content is only related to the content of this page. Under normal circumstances, if it is not particularly complex page, with the previous global style and common module style, there should be little to write."
    ],
    [
      "h4",
      "Component level"
    ...
    [
      ...
      [
        "p",
        "The above style categories are for independent style files. Sometimes the style configuration is especially simple and is not repeated. You can also use the inline style ",
        [
          "code",
          "style = {{...}}"
        ],
    ...
    [
      ...
      [
        ...
        [
          "p",
          "The imported antd component class name is not translated by CSS Modules, so the overridden class name ",
          [
            "code",
            ".ant-select-selection"
          ],
  ...
  "meta": {
    ...
    "title": "Style",
    "type": "Introduction",
    "filename": "docs/style.en-US.md"
  },
  "description": [
    "section",
    [
      "p",
      "This document is mainly about how to use and organize style files in projects. If you want to get a basic knowledge of CSS or look for properties usage, you can refer to the ",
      [
        "a",
        {
          "title": null,
  ...
  "toc": [
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Style-file-category",
          "title": "Style file category"
        },
        "Style file category"
      ]
    ],
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Override-the-component-style",
          "title": "Override the component style"
        },
        "Override the component style"
      ]
    ]
