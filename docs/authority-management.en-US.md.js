...
module.exports = {
  "content": [
    ...
    [
      "p",
      "This is the basis for scaffolding rights management. The basic idea is to determine whether to display normal rendering content or abnormal content by comparing the current permissions and access permissions. For details, see ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        "p",
        "The basic encapsulation of the RenderAuthorized function of component export in the scaffold (",
        [
          "a",
          {
            "title": null,
          ...
          "https://github.com/ant-design/ant-design-pro/blob/master/src/utils/Authorized.js"
        ],
        ") The permissions (mock data), so when using in the scaffold, do not need to pay attention to the current permissions."
      ]
    ],
    [
      "h3",
    ...
    [
      "p",
      "For permission control of certain menus, just go to the router configuration file ",
      [
        "a",
        {
          "title": null,
      ...
      ". The menu item sets the authority attribute, which represents the access permission of the route. In the route generation file, page components will be wrapped by ",
      [
        "code",
        "Authorized"
      ],
    ...
    [
      ...
      " can be easily Control element/component rendering. For details, see the component documentation."
    ],
    [
      "h3",
  ...
  "meta": {
    ...
    "type": "Advanced",
    "filename": "docs/authority-management.en-US.md"
  },
  "description": [
    "section",
    [
    ...
    [
      ...
      [
        "a",
        {
          ...
          "href": "#Authorization-component-Authorized",
          "title": "Authorization component Authorized"
        },
        "Authorization component Authorized"
      ]
    ],
