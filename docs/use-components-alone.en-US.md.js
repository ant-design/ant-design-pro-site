...
module.exports = {
  "content": [
    ...
    [
      "p",
      "The scaffold of Ant Design Pro provides a set of ",
      [
        "a",
        {
          "title": null,
      ...
      ", which abstract common block in admin interfaces. We will continue to maintain and iterate these components to provide a higher level of abstraction than Ant Design for admin interfaces."
    ],
    [
      "h2",
      "Usage"
    ...
    [
      "p",
      "For scaffolding users, you can import/add/reform pro's built-in components directly. Please refer to ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        "p",
        "Default components will be published to ",
        [
          "a",
          {
            "title": null,
    ...
    [
      ...
      {
        "lang": "jsx",
        "highlighted": "<span class=\"token keyword\">import</span> <span class=\"token string\">'ant-design-pro/dist/ant-design-pro.css'</span><span class=\"token punctuation\">;</span> <span class=\"token comment\" spellcheck=\"true\">// Import whole style</span>"
      },
      [
        "code",
  ...
  "meta": {
    ...
    "type": "Advanced",
    "filename": "docs/use-components-alone.en-US.md"
  },
  "toc": [
    "ul",
    [
