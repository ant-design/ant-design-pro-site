  ...
  "content": [
    ...
    [
      ...
      [
        ...
        [
          "p",
          "Call the unified management service request function;"
        ]
      ],
      [
        "li",
        [
          "p",
          "Send the request using the encapsulated request.js;"
        ]
      ],
      [
        "li",
      ...
      [
        ...
        [
          "p",
          "Then call reducer to change state;"
        ]
      ],
      [
        "li",
    ...
    [
      "p",
      "As can be seen from the above process, in order to facilitate management and maintenance, unified request processing is placed in the ",
      [
        "code",
        "services"
      ],
      " folder, and the files are generally split according to the model dimension, such as:"
    ],
    [
      "pre",
      {
    ...
    [
      ...
      ", which is convenient for handling POST, GET and other parameters, headers, and error messages. See ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "When dealing with complex asynchronous requests, it's easy to mess up the logic and get stuck in nesting traps, so the underlying infrastructure of Ant Design Pro ",
      [
        "a",
        {
          "title": null,
      ...
      " concept. To manage synchronized asynchronous requests:"
    ],
    [
      "pre",
      {
    ...
    [
      ...
      " the logical processing of asynchronous calls the same as synchronization, refer to ",
      [
        "a",
        {
          "title": null,
