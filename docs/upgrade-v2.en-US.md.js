...
module.exports = {
  "content": [
    ...
    [
      "p",
      "In addition to many features in the Ant Design Pro 2.0 release, we also upgraded the front-end build tool from roadhog to ",
      [
        "a",
        {
          "title": null,
      ...
      " (referred to as umi). The reason for upgrading, not replacement, is that umi is more than just a front-end build tool. It also includes routing and a plugin system for building a complete React application."
    ],
    [
      "p",
      "So if you want to better add the feature of Ant Design Pro 2.0 to your original project and port the 2.0 code to your project, you'd better migrate your project from roadhog to umi. This document will guide you through the migration process. Before that, you may need to read umi's ",
      [
        "a",
        {
          "title": null,
      ...
      " so that you have a preliminary understanding of umi. This is will helpful for your Migration work. The following are the overview of migration steps, and there will be more detail later."
    ],
    [
      "p",
      "Note: This migration guide is based on the latest v1 version, and you can find the changes in the ",
      [
        "a",
        {
          "title": null,
      ...
      ". This commit is for reference only and cannot be directly applied to your project. if your version is too old, there may be some difference in detail. Please migrate with the specific situation."
    ],
    [
      "h2",
    ...
    [
      ...
      [
        ...
        [
          ...
          " directory name to pages, where pages are the umi agreed directories."
        ]
      ],
      [
        "li",
        [
          ...
          " and the dva model in the models folder in umi will be mounted automatically."
        ]
      ],
      [
        "li",
        [
          ...
          ", which is the file agreed by umi."
        ]
      ],
      [
        "li",
        [
          ...
          ", which are also umi-constrained files."
        ]
      ],
      [
        "li",
        [
          "p",
          "Add route configuration routes in ",
          [
            "code",
            "config/config.js"
          ],
      ...
      [
        ...
        [
          "p",
          "Modify the component nesting syntax in ",
          [
            "code",
      ...
      [
        ...
        [
          "p",
          "Modify possible problems by executing ",
          [
            "code",
            "tnpm start"
          ],
    ...
    [
      ...
      " in the root directory of the project and change the dependency to umi:"
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "React is built into umi, and a library commonly used by React technology stacks such as antd and dva is built into the umi-plugin-react plugin set. See ",
      [
        "a",
        {
          "title": null,
        ...
        "Minor-plugin-react documentation"
      ],
      "."
    ],
    [
      "p",
      "In addition, the scripts in ",
      [
        "code",
        "package.json"
      ],
      " also need to be modified accordingly:"
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "Remember to don't forget to update the dependency to the latest with ",
      [
        "code",
        "npm update"
      ],
    ...
    [
      ...
      " as umi's configuration files (choose one). In Ant Design Pro, because of the more configuration, we choose to use ",
      [
        "code",
        "config/config.js"
      ],
    ...
    [
      ...
      " in your project. This configuration file needs to export an object by default, which contains all the configuration of umi. You can initialize it to the following:"
    ],
    [
      "pre",
      {
    ...
    [
      ...
      " you can also migrate the configuration from ",
      [
        "code",
        ".webpackrc.js"
      ],
      " under your project to ",
      [
        "code",
        "config/config.js"
      ],
      ...
      " is the af-webpack configuration file, umi and roadhog are dependent on it, so you can migrate directly. After the migration, you can delete the original ",
      [
        "code",
        ".webpackrc.js"
      ],
    ...
    [
      "p",
      "However, it should be noted that the following configuration in ",
      [
        "code",
        ".webpackrc.js"
      ],
      " is not necessary to copy into ",
      [
        "code",
        "config/config.js"
      ],
    ...
    [
      ...
      [
        ...
        [
          "p",
          "alias: umi will add the alias of ",
          [
            "code",
            "@/"
          ],
          " to the src directory by default."
        ]
      ],
      [
        "li",
        [
          ...
          " as the html template by default."
        ]
      ]
    ],
    [
      "p",
      "In addition, we recommend writing the ",
      [
        "code",
        "theme"
      ],
    ...
    [
      "p",
      "A lot of conventions and configurations are used in umi to efficiently implement some functions, where umi agrees that the ",
      [
        "code",
        "src/pages"
      ],
      " directory is the directory where the page components are stored. In Ant Design Pro 1.0, our pages are stored under ",
      [
        "code",
        "src/routes"
      ],
      ", so we only need to rename the routes to pages."
    ],
    [
      "h3",
    ...
    [
      "p",
      "In umi, after the dva plugin is mounted, the files under models will be introduced as dva model by default, so you no longer need to manually mount the model in ",
      [
        "code",
        "models/index.js"
      ],
      ", you can delete the file directly."
    ],
    [
      "h3",
      "Modify index.ejs"
    ...
    [
      ...
      ", which is the file agreed by umi. Reference ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      " and they will be mounted automatically by umi. You can refer to umi's ",
      [
        "a",
        {
          "title": null,
      ...
      ". In addition, because the dva plugin will automatically mount the model and add the dva-loading plugin by default, the dva related content in index.js can be removed. Just keep the initialization logic like this:"
    ],
    [
      "pre",
      {
    ...
    [
      ...
      " can also be removed, because the style in ",
      [
        "code",
        "global.less"
      ],
      " is global by default. It should be noted that cssModule is used by default except for it."
    ],
    [
      "h3",
    ...
    [
      "p",
      "This step is the most important, umi has built-in routing implementation, providing both agreed and configured routing. In Ant Design Pro we use the way of profile routing. You need to add the configuration item ",
      [
        "code",
        "routes"
      ],
      ...
      ", here we provide a sample based on the ",
      [
        "code",
        "/dashboard"
      ],
      " page, you need to do the migration according to your project. We recommend adding a ",
      [
        "code",
        "config/router.config.js"
      ],
      " file and introducing it in ",
      [
        "code",
        "config/config.js"
      ],
    ...
    [
      "p",
      "Where component is a string, relative to the path of ",
      [
        "code",
        "src/pages"
      ],
      ", for more routing configuration you can refer to the v2 version of the routing configuration, and umi's documentation. In addition, the original 1.0 version of the routing code ",
      [
        "code",
    ...
    [
      "p",
      "Because component routing is not used with react-router@4, you will need to modify your layout components. Change the ",
      [
        "code",
        "<Switch/>"
      ],
    ...
    [
      ...
      " is used as the 404 page in umi, you need to migrate the original ",
      [
        "code",
    ...
    [
      "p",
      "In 2.0, you can use the ",
      [
        "span",
        "Permissions Routing"
      ],
      " provided by umi directly (",
      [
        "a",
        {
          "title": null,
          "href": "https://umijs.org/guide/router.html#%E6%9D%83%E9%99%90%E8%B7%AF%E7"
        },
        "https://umijs.org/guide/router.html#%E6%9D%83%E9%99%90%E8%B7%AF%E7"
      ],
      " %94%B1) program. Of course, you can also keep the scheme in 1.0 to continue to use. Since it is not necessary, it will not be specified in this article."
    ],
    [
      "h3",
      "Modifying mock data"
    ...
    [
      ...
      " file is used as the mock file by default. So you can delete the ",
      [
        "code",
        ".roadhogrc.mock.js"
      ],
      " file after migrating the URL information of the mock data to the mock file, but note that the mock data written directly in ",
      [
        "code",
        ".roadhogrc.mock.js"
      ],
      " needs to be migrated, for example You can migrate this part of the data by creating a new ",
      [
        "code",
        "mock/common.js"
      ],
    ...
    [
      "p",
      "For more instructions, please refer to umi's documentation ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "After using umi you need to add the temporary files of umi in development and build to ",
      [
        "code",
        ".gitignore"
      ],
    ...
    [
      "p",
      "After the above operation is completed, you can run ",
      [
        "code",
        "npm start"
      ],
      " to start your project. You will see an error, but don't panic, follow the error message and modify it step by step. What you may need to modify is:"
    ],
    [
      "ul",
      [
        ...
        [
          ...
          ". Of course, you can also keep the original alias directly in ",
          [
            "code",
            "config/config.js"
          ],
      ...
      [
        ...
        [
          "p",
          "Modify the part related to dva in ",
          [
            "code",
      ...
      [
        ...
        [
          ...
          ", the logic of the jump can be implemented through umi's routes configuration."
        ]
      ],
      [
        "li",
        [
          ...
          ", refer to the following code implementation. Complete code reference v1 upgrade ",
          [
            "a",
            {
              "title": null,
    ...
    [
      ...
      " is the method provided by the ",
      [
        "code",
        "memoize-one"
      ],
      " npm package. You need to install memoize-one first. ",
      [
        "code",
        "deepEqual"
      ],
      ...
      " package, and related dependencies need to be installed."
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "In addition to the project can start normally, you should also run ",
      [
        "code",
        "tnpm run lint"
      ],
      " to solve the lower-level problems that occur in the migration process. The problems and scenarios you may need to deal with are as follows:"
    ],
    [
      "ul",
      [
        ...
        [
          ...
          " error, you can delete it without checking the problem."
        ]
      ],
      [
        "li",
        [
          ...
          " error, you may need to modify something like ",
          [
            "code",
            "this.props.children"
          ],
    ...
    [
      "p",
      "You only need to copy the related code in the v2 ",
      [
        "code",
        "pages"
      ],
      " directory to your project and modify the routes configuration in ",
      [
        "code",
        "config/config.js"
      ],
      ". This part is relatively simple, and I won't explain too much here. In addition to the new user information page, you can also refer to the update of other pages to jump to the code in your own project."
    ],
    [
      "h3",
      "Support internationalization"
    ...
    [
      "p",
      "In Ant Design Pro 2.0 we used the umi plugin ",
      [
        "code",
        "umi-plugin-locale"
      ],
      " for i18n. The plugin has also been built into the ",
      [
        "code",
        "umi-plugin-react"
      ],
      " plugin set. You can turn on i18n by adding the ",
      [
        "code",
        "locale"
      ],
      " configuration to the configuration of the collection."
    ],
    [
      "p",
      "After opening the i18n plugin, you can add the ",
      [
        "code",
        "locales"
      ],
      " folder in the project directory, add the i18n resource file according to the convention, and then you can internationalize by using the API exposed by ",
      [
        "code",
        "umi/locale"
      ],
    ...
    [
      ...
      " configuration can be plugged into its ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Ant Design Pro uses less and cssModule as a style solution. You can configure this theme style by configuring lessVars at compile time. This function is built in umi. You can configure ",
      [
        "code",
        "theme"
      ],
      " in the configuration file. Refer to umi's ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "However, the adjustment of the navigation layout mode supported by the v2 version is mainly the upgrade of the business logic of the code. You can refer to the code of ",
      [
        "code",
        "src/layouts/BasicLayout.js"
      ],
      " in the v2 code for adjustment."
    ],
    [
      "p",
      "For online theme switching, because less is compiled at build time, in order to achieve switching, you need to support less in online compilation and other issues. To solve this problem, we developed the ",
      [
        "code",
        "ant-design-theme"
      ],
      " webpack plugin and the ",
      [
        "code",
        "merge-less"
      ],
      " plugin to implement this feature. if you need it, you can add the related code by referring to ",
      [
        "code",
  ...
  "meta": {
    ...
    "title": "Upgrade to V2",
    "type": "Other",
    "filename": "docs/upgrade-v2.en-US.md"
  },
  "toc": [
    "ul",
    [
      ...
      [
        "a",
        {
          ...
          "href": "#Migration-Steps-Overview",
          "title": "Migration Steps Overview"
        },
        "Migration Steps Overview"
      ]
    ],
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Migration-step-details",
          "title": "Migration step details"
        },
        "Migration step details"
      ]
    ],
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Using-the-new-features-in-2.0",
          "title": "Using the new features in 2.0"
        },
        "Using the new features in 2.0"
      ]
    ]
