...
module.exports = {
  "content": [
    ...
    [
      "p",
      "We abstract common layouts in Ant Design Pro, and put them in ",
      [
        "code",
        "/layouts"
      ],
    ...
    [
      "p",
      "To manage mappings between routes and pages, we could configure ",
      [
        "code",
    ...
    [
      "p",
      "And more router config could be found in：",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        [
          ...
          ": display name in menu and breadcrumb. Note that it is the key of locales data, you can change display text in  ",
          [
            "a",
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design-pro/blob/v2/src/locales/en-US.js"
            },
      ...
      [
        ...
        [
          ...
          ": whether hide itself in menu, default ",
          [
            "code",
            "false"
          ],
      ...
      [
        ...
        [
          ...
          ": whether hide it's children in menu, default ",
          [
            "code",
            "false"
          ],
      ...
      [
        ...
        [
          ...
          ": whether hide itself in breadcrumb, default ",
          [
            "code",
            "false"
          ],
    ...
    [
      "p",
      "Ant Design currently provides two components for layout: ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Grid Component provided by Ant Design is tremendously powerful. you can set span, responsive columns, and optional ",
      [
        "code",
        "flex"
      ],
      " layout. It covers a majority of use-cases: See ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "If you need more structured layout components, then ",
      [
        "a",
        {
          "title": null,
      ...
      " is your best option. You only need to fill in the blanks to build professional layout. See ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Under most cases, we will build more specific components from the above ones, that includes navigation, sidebar, notification, titles etc., An example would be ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "We put layout components inside ",
      [
        "code",
        "layouts"
      ],
      ...
      ". It is worth noting that layout components has no fundamental difference from other components, just that it deals with layout."
    ],
    [
      "blockquote",
      [
        "p",
        "Beside components provided by Ant Design React, you could try layout components from ",
        [
          "a",
          {
            "title": null,
  ...
  "toc": [
    ...
    [
      ...
      [
        "a",
        {
          ...
          "href": "#Layout-in-Ant-Design-Pro",
          "title": "Layout in Ant Design Pro"
        },
        "Layout in Ant Design Pro"
      ]
    ],
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Ant-Design-Components-for-layout",
          "title": "Ant Design Components for layout"
        },
        "Ant Design Components for layout"
      ]
    ],
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Building-layout-components-for-specific-use-cases.",
          "title": "Building layout components for specific use cases."
        },
        "Building layout components for specific use cases."
      ]
    ]
