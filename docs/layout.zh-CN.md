...
- 当不需要展示在菜单中展示时，可以在路由上配置
hideInMenu 或者删除 menu 相关的配置；
...
用户名以及国际化可以通过配置拥有默认的 UI。
国际化会通过检测 locale 目录下的文件来展示可供切换的语言种类。
...
![404](https://gw.alipayobjects.com/mdn/rms_30ab81/afts/img/A*LOPuQoOGJIcAAAAAAAAAAABkARQnAQ)
