...
module.exports = {
  "content": [
    ...
    [
      ...
      " to proxy or mock data in Ant Design Pro."
    ],
    [
      "h2",
      "Use roadhog"
    ...
    [
      ...
      " in your project root directory to mock API like below, more detail in ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "When you start server by ",
      [
        "code",
        "roadhog dev"
      ],
      ", the mock service will proxy network requests as follow your rules defined in ",
      [
        "code",
        ".roadhogrc.mock.js"
      ],
    ...
    [
      "p",
      "Now you can see the result in browser console when visits ",
      [
        "code",
        "/api/users"
      ],
    ...
    [
      ...
      " is a popular mock library that can help to generate mock data, we can use it in ",
      [
        "code",
        ".roadhogrc.mock.js"
      ],
    ...
    [
      "p",
      "We can maintain our mock data in different files for different data models in the large application, and import them in ",
      [
        "code",
        ".roadhog.mock.js"
      ],
    ...
    [
      "p",
      "You can implement the API within ",
      [
        "code",
        "setTimeout"
      ],
    ...
    [
      "p",
      "A detailed API documentation includes path, method, params and response will be helpful when we collaborate with server-side developer. ",
      [
        "code",
        "roadhog-api-doc"
      ],
      " can generate one from your ",
      [
        "code",
        ".roadhog.mock.js"
      ],
    ...
    [
      "p",
      "Implement you API information in ",
      [
        "code",
        ".roadhog.mock.js"
      ],
    ...
    [
      ...
      [
        ...
        {
          "width": "500",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/TKmBIxyMTBiMJZtAlBgg.png"
        }
      ]
    ],
    [
    ...
    [
      "p",
      "If you need to integrate with real service after finish front end development via mock data, just ",
      [
        "a",
        {
          "title": null,
        ...
        "close the mock data or proxy request to the real interfaces"
      ],
      "."
    ],
    [
  ...
  "meta": {
    ...
    "title": "Mock Data",
    "type": "Advanced",
    "filename": "docs/mock-api.en-US.md"
  },
  "toc": [
    "ul",
    [
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Divide-mock-data-into-different-files",
          "title": "Divide mock data into different files"
        },
        "Divide mock data into different files"
      ]
    ],
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Generate-API-documentation",
