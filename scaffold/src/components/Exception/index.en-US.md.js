...
module.exports = {
  ...
  "meta": {
    ...
    "cols": 1,
    "order": 5,
    "filename": "scaffold/src/components/Exception/index.en-US.md"
  },
  "toc": [
    "ul",
    [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "type of exception, the corresponding default ",
            [
              "code",
              "title"
            ],
            ...
            " will be given if set, which can be overridden by explicit setting of ",
            [
              "code",
              "title"
            ],
        ...
        [
          ...
          [
            "td",
            "suggested operations, a default 'Home' link will show if not set"
          ],
          [
            "td",
            "ReactNode"
        ...
        [
          ...
          [
            "td",
            "to specify the element of link"
          ],
          [
            "td",
            "string",
